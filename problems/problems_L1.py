...
class FunctionalNN():
    ...
    def net_oracle(self, X, y):
        ...
        mlp_oracle = build_autodiff(mlp_loss)

        # translate the parameters 
        def oracle(w, vals="fgH"):
            w_par = self.params # relabel for clarity
            vector_to_parameters(w, w_par)
